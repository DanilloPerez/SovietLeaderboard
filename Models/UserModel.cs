...
namespace Models
{
    public class UserModel
    {
        ...
        public LeaderboardTypes leaderboardtypes { get; set; }
        public Countries countries { get; set; }
        
        public UserModel(string UserID, string UserName, Genre genre, LeaderboardTypes leaderboardtypes, Countries countries)
        {
            this.UserID = UserID;
            this.UserName = UserName;
            this.genre = genre;
            this.leaderboardtypes = leaderboardtypes;
